...
const DEFAULT_AUTH_TEST_INTERNAL_TOOL_PROMPT: &str = "Use exactly one read-only file listing or search tool to inspect the current working directory. After that internal tool finishes, reply with exactly AUTH_TEST_OK and nothing else.";
